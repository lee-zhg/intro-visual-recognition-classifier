...
1. Rename the model to `My Bottle Model`. The default name is `Default Custom Model`.
...
1. Click the `Train Model` button on the top-right.
...
1. Select or drag/drop testing image file `data/BrooklynLager-test.JPG` to the canvas.
